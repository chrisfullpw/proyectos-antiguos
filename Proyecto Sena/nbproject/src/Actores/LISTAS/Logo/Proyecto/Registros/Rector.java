...
public class Rector extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        barra.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Rector", "Coordinador", "Docente", "Estudiante" }));
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, fondoLayout.createSequentialGroup()
                        .addGroup(fondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, fondoLayout.createSequentialGroup()
                                ...
                                .addGap(30, 30, 30)))
                        .addGap(10, 10, 10)
                        .addComponent(txt_idinst, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(79, 79, 79))))
        );
    ...
    private void btenviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btenviarActionPerformed
        ...
        try {
            ...
            try {
                stmt.executeUpdate("INSERT INTO Rector VALUES('"+cadena2+"','"+cadena3+"','"+cadena4+"','"+cadena5+"','"+cadena6+"','"+cadena7+"','"+cadena8+"')");
